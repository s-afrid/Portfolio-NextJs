...
const [tools, settools] = useState([
  ...
  return (
    <div className="h-[calc(100vh-80px-90px)] md:h-[calc(100vh-80px-160px)] xl:h-[calc(100vh-80px-100px)] pt-12 2xl:pt-2 pb-15 2xl:pb-2 flex flex-col items-center justify-start 2xl:justify-center md:w-[80%] m-auto overflow-y-auto no-scrollbar gap-10 md:gap-20 p-3">
