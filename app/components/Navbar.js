...
const Navbar = () => {
  return (
    <div className='sticky top-0 z-50 w-full bg-gray-90'>
      
      <nav className='relative z-10 w-full h-20 font-tech md:text-2xl hidden md:block bg-transparent border-0'>
