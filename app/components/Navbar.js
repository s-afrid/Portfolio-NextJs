...
const Navbar = () => {
  return (
    <div className='sticky'>
     <div className="absolute inset-0 w-full h-25 md:h-27 2xl:h-36 backdrop-blur-2xl hidden md:block md:[mask-image:linear-gradient(to_bottom,black_40%,transparent)]"></div>
