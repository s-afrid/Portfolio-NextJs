  ...
  return (
   <div className="flex flex-col xl:flex-row items-center justify-around h-[calc(100%-80px)] gap-7 p-3 md:w-[80%] m-auto">
    ...
    <div className="about flex flex-col lg:w-[80%] gap-10">
      ...
      <a className="resume flex items-center justify-center gap-2 px-3 py-1 rounded-2xl [box-shadow:5px_5px_#0c0c0c] font-tech text-center md:text-left self-center md:self-start text-lg lg:text-md bg-white text-black hover:invert [transition:all_0.8s_ease] hover:scale-110" href="https://afrid0052.hackerresume.io/a19b6aad-77f4-4d6b-a5b1-25f1060b7645" target="_blank" rel="noopener noreferrer">Resume 
      <lord-icon
